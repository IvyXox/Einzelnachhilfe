...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="">Verifizierung</a>
          </li>
          <?php
          if($_SESSION['role'] == "admin"){
            ?>
            <li class="nav-item active">
              <a class="nav-link" href="../userview/">Users</a>
            </li>
            <?php
          }
          ?>
  ...
  <section class="header" id="header">
    <div class="container text-white">
      <h1><i class="fa fa-cog" aria-hidden="true"></i> Verifizierung</h1>
    </div>
  </section>
  <!-- End Header -->
      ...
      <div class="row">
        <div class="col-lg-3 col-md-4">
          ...
          <ul class="list-group">
            ...
            <li class="list-group-item"><a href="">Verifizierung</a></li>
            <?php
            if($_SESSION['role'] == "admin"){
              ?>
